...
describe('Delete user document', () => {
    ...
    it('Delete one user using its instance', () => {
        return user.remove()
    ...
    it('Delete multiple users matching using model', () => {
        return User.deleteMany({ _id: user._id })
            .then(() => User.findOne({ _id: user._id })
                .then((user) => {
                    assert(user == null);
                })
    ...
    it('Delete one user matching using model' , () => {
